...
type KuyavianPomeranianVoivodeshipClubsProps = {
  params: {
    country: string;
  };
};

const KuyavianPomeranianVoivodeshipClubs: NextPage<
  KuyavianPomeranianVoivodeshipClubsProps & PageProps
...
export default KuyavianPomeranianVoivodeshipClubs;
