...
type RepresentationEuropeCountryProps = {
  params: {
    country: string;
  };
};

const RepresentationEuropeCountry: NextPage<
  RepresentationEuropeCountryProps & PageProps
...
export default RepresentationEuropeCountry;
