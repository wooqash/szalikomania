...
const WarmianMasurianVoivodeshipClubs: NextPage = () => {
  return (
    <>
      <Head>
        <title>Warmińsko-Mazurskie - Polskie kluby - Szalikomania</title>
...
export default WarmianMasurianVoivodeshipClubs;
